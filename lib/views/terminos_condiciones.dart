      ...
      appBar: AppBar(
        ...
        title: Column(
          children: [
            ...
            Text(
              'Actualizado el 2024-01-11',
              style: GoogleFonts.quicksand(fontSize: 17, color: Themes.primary),
            ),
          ],
        ),
      ),
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                      ...
                      child: RichText(
                        text: TextSpan(
                          ...
                          children: <TextSpan>[
                            ...
                            const TextSpan(
                                text:
                                    ' o los propietarios / fundadores de Motul, en este caso es Mexico'),
                          ],
                        ),
                      ),
                    ),
              ...
              const SizedBox(height: 20),
              Text(
                '¿Cuándo usa Motul la información del usuario final de terceros?',
                style: GoogleFonts.quicksand(
                    fontSize: 22, color: Colors.black.withOpacity(.8)),
              ),
              const SizedBox(height: 20),
              ...
              const SizedBox(height: 20),
              Text(
                '¿Cuándo usa Motul la información del cliente de terceros?',
                style: GoogleFonts.quicksand(
                    fontSize: 22, color: Colors.black.withOpacity(.8)),
              ),
              const SizedBox(height: 20),
              ...
              const SizedBox(height: 20),
              Text(
                '¿La información recopilada a través del Servicio Motul es segura?',
                style: GoogleFonts.quicksand(
                    fontSize: 22, color: Colors.black.withOpacity(.8)),
              ),
              const SizedBox(height: 20),
                      ...
                      child: RichText(
                        text: TextSpan(
                          ...
                          children: const <TextSpan>[
                            TextSpan(
                                text:
                                    'A través de correo electrónico: Motul@Motul.com'),
                          ],
                        ),
                      ),
                    ),
                      ...
                      child: RichText(
                        text: TextSpan(
                          ...
                          children: const <TextSpan>[
                            TextSpan(
                                text:
                                    'A través de este enlace: https://www.Motuldelivery.com.mx/'),
                          ],
                        ),
                      ),
                    ),
